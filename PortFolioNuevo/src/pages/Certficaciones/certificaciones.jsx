...
const Certificaciones = () => {
  ...
  const soyHenryImages = ['/assets/imagen5.png', '/assets/imagen6.png'];
    ...
    <div className="p-2 mt-40 mb-40">
      <div className={`container mx-auto`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div
            className={`flex flex-col items-center gap-8 text-black rounded-lg shadow-md p-6 ${lightMode ? 'bg-black bg-opacity-80' : 'bg-white'}`}
          >
            <h1 className="text-3xl text-green-600 font-bold mb-4">NextU</h1>
            <div className="rounded-lg">
              <Image
                src={imagen1}
                alt="Certificación NextU"
                width={500}
                height={250}
