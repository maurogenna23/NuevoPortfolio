    ...
    return (
      <div className="flex flex-col-reverse lg:flex-row p-2 mt-40 mb-40">
        <div className="w-full lg:w-1/2 p-2 flex items-center justify-center animated animate__fadeIn">
          <div
            className={`max-w-3xl p-8 shadow-xl w-full border rounded-md text-center ${lightMode ? 'bg-black bg-opacity-80' : 'bg-white'}`}
          >
            <p
              className={`text-4xl mb-4 ${lightMode ? ' text-green-400' : 'text-green-600'}`}
            >
              {translations.contact.paragraph1}
            </p>
            <p className={`text-xl ${lightMode ? 'text-white' : ''}`}>
              {translations.contact.paragraph2}
            </p>
            <div className="mt-10">
              <p className={`${lightMode ? 'text-gray-300' : ''}`}>
                {translations.contact.paragraph3}
              </p>
              <div className="flex justify-center space-x-4 mt-2">
                ...
                <a
                  href="https://www.instagram.com/mauro_genna/"
